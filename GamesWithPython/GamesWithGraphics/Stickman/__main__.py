...
class Game:
    def __init__(self):
        ...
        self.sprites = []
        self.running = True
        self.game_over_text = self.canvas.create_text(250, 250, text='YOU WIN!', font=('Times', 30), state='hidden',
                                                      fill='#ffd561')
...
platform7 = PlatformSprite(g, PhotoImage(file="images/platform2.gif"), 170, 120, 66, 10)
